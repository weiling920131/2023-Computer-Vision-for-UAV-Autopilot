        ...
        if key != -1:
            ...
            if flag == 3:
                ...
                for x,y,w,h in rects:
                    ...
                    # if find another face have distance larger then 8, means that found 2 face in 1 screen 
                
                # if found 2 faces, then use 2 x_update to 
                if face2_num == 2:
                ...
                # frame = cv2.aruco.drawDetectedMarkers(frame, markerCorners, markerIds)
                    ...
                    for i in range(len(markerIds)):
                        ...
                        if id == 3 and flag == 4:
                            ...
                            if abs(x_update) <= 10 and abs(z_update) <= 150 and abs(yaw_update) <= 5:
                                drone.land()
                                break
                    ...
                    # if not detect aruco-id-3, then turn left
